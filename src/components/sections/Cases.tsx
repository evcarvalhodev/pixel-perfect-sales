...
const cases: Case[] = [
  ...
  {
    tag: "VSL",
    tagColor: "bg-[oklch(0.65_0.18_50/0.15)] text-[oklch(0.55_0.2_50)]",
    ...
    <Section className="bg-muted/40">
      ...
      <div className="mt-14 grid gap-6 md:grid-cols-2 lg:gap-8">
        {cases.map((c, i) => (
          <article
            key={i}
            className="group overflow-hidden rounded-3xl border border-border bg-card shadow-[0_4px_24px_-6px_oklch(0_0_0/0.08)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_40px_-8px_oklch(0_0_0/0.15)]"
          >
