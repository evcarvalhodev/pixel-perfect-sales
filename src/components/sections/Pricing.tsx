    ...
    <Section className="bg-muted/40">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h2 className="mt-3 text-balance text-3xl font-bold md:text-5xl">
          Tudo que voce precisa por{" "}
          <span className="text-whatsapp">R$ 1.997</span>
        </h2>
      </div>
      ...
      <div className="mx-auto mt-10 flex max-w-2xl items-start gap-3 rounded-2xl border border-[oklch(0.7_0.15_70/0.3)] bg-[oklch(0.7_0.15_70/0.08)] p-4 md:p-5">
        <AlertCircle className="h-5 w-5 shrink-0 text-[oklch(0.55_0.18_60)]" />
