...
const steps = [
  {
    days: "Dia 1-2",
    title: "Reuniao estrategica + analise do seu produto e publico",
    icon: Search,
  },
  {
    days: "Dia 3-4",
    title: "Construcao da pagina de vendas com copy persuasiva",
    icon: PenTool,
  },
  {
    days: "Dia 5-6",
    title: "Setup completo das campanhas de trafego pago",
    icon: Target,
  },
  {
    days: "Dia 7",
          ...
          {steps.map((step, i) => {
            ...
            return (
              <div key={i} className="relative flex gap-5 md:gap-6">
                <div className="relative z-10 flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-electric to-[oklch(0.55_0.18_245)] text-white shadow-lg md:h-16 md:w-16">
