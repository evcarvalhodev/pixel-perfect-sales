...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-dark-section px-5 pb-20 pt-16 text-dark-foreground md:px-8 md:pb-28 md:pt-24">
      {/* decorative glows */}
      <div className="pointer-events-none absolute -top-40 right-0 h-96 w-96 rounded-full bg-[oklch(0.65_0.16_245/0.15)] blur-3xl" />
      <div className="pointer-events-none absolute -bottom-40 -left-20 h-96 w-96 rounded-full bg-[oklch(0.72_0.18_145/0.1)] blur-3xl" />
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 md:grid-cols-[1.3fr_1fr]">
        ...
        <div className="order-first flex justify-center md:order-last">
          <div className="relative">
            ...
            <div className="relative flex h-56 w-56 items-center justify-center rounded-full border-4 border-white/10 bg-gradient-to-br from-[oklch(0.25_0.04_260)] to-[oklch(0.18_0.03_260)] text-6xl font-bold text-dark-foreground shadow-2xl md:h-72 md:w-72 md:text-7xl">
              EC
            </div>
